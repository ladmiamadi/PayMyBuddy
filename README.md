...
![alt text](https://github.com/ladmiamadi/PayMyBuddy/blob/final-branch/edit-profile-paymybuddy.png?raw=true)

# Check Balance and transfert money page
![alt text](https://github.com/ladmiamadi/PayMyBuddy/blob/final-branch/balance-pay-my-buddy.png?raw=true)

# Adding a new connection page
![alt text](https://github.com/ladmiamadi/PayMyBuddy/blob/final-branch/add-new-connection.png?raw=true)
